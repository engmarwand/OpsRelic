                    ...
                    <div key={client.id} className="bg-[var(--color-surface)] border border-[var(--color-border-subtle)] rounded-2xl p-5 shadow-sm transition-all duration-200 cursor-pointer relative overflow-hidden hover:-translate-y-[2px] hover:shadow-md hover:border-strong" onClick={() => setSelectedClient(client)}>
                      ...
                      <div className="grid grid-cols-4 gap-2 mb-3">
                        ...
                        <div className="bg-[var(--color-surface2)] rounded-[10px] p-[10px] text-center">
                           ...
                           <div className="font-bold font-display mt-0.5">{formatViews(stats.views)}</div>
                        </div>
                        <div className="bg-[var(--color-surface2)] rounded-[10px] p-[10px] text-center">
                           <div className="text-[10px] uppercase text-muted font-black tracking-widest truncate">Clips</div>
                           <div className="font-bold font-display mt-0.5">{stats.clips}</div>
                        </div>
                        <div className="bg-[var(--color-surface2)] rounded-[10px] p-[10px] text-center">
                           <div className="text-[10px] uppercase text-brand-primary font-black tracking-widest truncate">Margin</div>
                           <div className="font-bold font-display mt-0.5 text-brand-primary tabular-nums">${stats.profit.toLocaleString()}</div>
                        </div>
                      </div>
