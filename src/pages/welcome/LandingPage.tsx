...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)] font-sans selection:bg-[var(--color-primary-soft-2)] overflow-x-hidden transition-colors duration-500">
          ...
          <a href="#" className="flex items-center gap-3 group">
            <div className="w-12 h-12 flex items-center justify-center transition-all group-hover:scale-110">
              <img
                src="/logo.png"
                alt="OpsRelic Logo"
                className="w-full h-full object-contain drop-shadow-[0_4px_12px_var(--color-primary-soft-2)]"
              />
            </div>
            <div className="flex flex-col">
              <span className="font-black text-2xl tracking-tighter text-[var(--color-text)] leading-none">
                OpsRelic
              </span>
              <span className="text-[10px] font-black text-[var(--color-primary)] tracking-[0.3em] uppercase mt-1 opacity-80">
                Clipping & UGC Agency OS
              </span>
            </div>
          </a>
          ...
          <div className="w-full relative z-10">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-[76px] font-black tracking-[-0.07em] lg:tracking-[-0.08em] leading-[0.9] mb-8 text-[var(--color-text)]">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-hover)]">
                  Clipping Agency & UGC Teams.
                </span>
              </h1>

              <p className="text-lg lg:text-xl text-[var(--color-text-muted)] leading-relaxed mb-12 max-w-lg font-medium opacity-85">
                OpsRelic is the all-in-one software for clipping agency
                workflows. Centralize your entire operation—from raw performance
                metrics to branded client portals—and give your UGC team the
                professional infrastructure to report fast, stay organized, and
                scale efficiently.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-5 mb-16 lg:mb-20">
                <a
                  href="#waitlist"
                  className="h-[64px] px-10 rounded-2xl bg-[var(--color-primary)] text-[var(--color-text-inverse)] font-black flex items-center justify-center shadow-[0_16px_32px_-8px_var(--color-primary-soft-2)] hover:scale-[1.02] hover:brightness-110 active:scale-95 transition-all text-xl group relative overflow-hidden"
                >
          ...
          <div className="relative w-full lg:h-[600px] flex items-center justify-center mt-12 lg:mt-0 perspective-3000">
            ...
            <div className="dashboard-shell relative w-full h-auto min-h-[450px] aspect-video max-w-[800px] bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-[0_32px_64px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col pointer-events-none">
              ...
              <div className="h-10 border-b border-[var(--color-border)] flex items-center px-4 gap-4 bg-[var(--color-surface-2)] shrink-0">
                ...
                <div className="w-64 h-5 rounded-md bg-[var(--color-surface-offset)] mx-auto flex items-center justify-center text-[10px] text-[var(--color-text-muted)] tracking-widest font-mono">
                  opsrelic.com/app
                </div>
              </div>
              {/* Body */}
              <div className="flex flex-1 overflow-hidden">
                ...
                <div className="hidden sm:flex w-48 border-r border-[var(--color-border)] bg-[var(--color-surface)] p-4 flex-col gap-2 opacity-80">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="h-4 rounded bg-[var(--color-surface-offset)] w-3/4" />
                  </div>
                  <div className="flex items-center gap-2 mb-2">
                    <Users className="w-4 h-4 text-muted" />
                    <div className="h-4 rounded bg-[var(--color-surface-offset)] w-5/6" />
                  </div>
                  <div className="flex items-center gap-2 mb-2">
                    <Database className="w-4 h-4 text-muted" />
                    <div className="h-4 rounded bg-[var(--color-surface-offset)] w-full" />
                  </div>
                  <div className="flex items-center gap-2 mb-2">
                    <Globe className="w-4 h-4 text-[var(--color-primary)]" />
                    <div className="h-4 rounded bg-[var(--color-primary-soft-2)] text-[var(--color-primary)] w-4/5" />
                  </div>
                </div>
                {/* Main */}
                <div className="flex-1 p-4 sm:p-6 bg-[var(--color-bg)] flex flex-col gap-4 sm:gap-6 overflow-hidden relative">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 relative z-10">
                    <div className="h-20 sm:h-24 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-2)]/80 backdrop-blur-md p-3 sm:p-4 flex flex-col justify-between shadow-sm">
                      <div className="text-[9px] sm:text-[10px] font-bold text-[var(--color-text-muted)] uppercase tracking-widest">
                        Total Views
                      </div>
                    ...
                    <div className="h-20 sm:h-24 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-2)]/80 backdrop-blur-md p-3 sm:p-4 flex flex-col justify-between shadow-sm">
                      ...
                      <div className="text-xl sm:text-2xl font-black text-[#00ff88]">
                        12
                      </div>
                    </div>
                    <div className="h-20 sm:h-24 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-2)]/80 backdrop-blur-md p-3 sm:p-4 flex flex-col justify-between hidden md:flex shadow-sm">
                      ...
                      <div className="text-xl sm:text-2xl font-black text-[#0077ff]">
                        140+ hrs
                      </div>
                    </div>
                  </div>
                  <div className="flex-1 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-2)]/80 backdrop-blur-md relative z-10 p-4 opacity-70">
                    ...
                    <div className="space-y-3">
                      {[1, 2, 3].map((i) => (
                        <div
                          key={i}
                          className="flex justify-between items-center pb-3 border-b border-[var(--color-divider)]"
                        >
                          ...
                          <div className="h-4 w-12 rounded bg-[var(--color-primary-soft)] text-[var(--color-primary)] font-mono text-[10px] text-center flex items-center justify-center">
                            +1{i}k
                          </div>
                        </div>
                      ))}
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                ...
                <span className="text-[10px] sm:text-xs font-bold text-[var(--color-text)]">
                  Client Portal Synced
                </span>
              </div>
      ...
      <section
        id="capabilities"
        className="py-24 bg-[var(--color-surface)] border-t border-[var(--color-border)]"
      >
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center mb-20 max-w-2xl mx-auto">
            <span className="eyebrow">The OpsRelic Suite</span>
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6 mt-4">
              One Operating System for your entire agency.
            </h2>
            <p className="text-lg text-[var(--color-text-muted)]">
              From intake to final portal delivery, manage every aspect of your
              agency inside OpsRelic.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Manage your workspaces, team access, and subscription tiers cleanly.",
              },
              {
                icon: Layers,
                title: "Dedicated Campaign Instances",
                desc: "No more scattered Google Sheets. Each campaign gets a structured hub with integrated clipping targets.",
              },
              {
                icon: BarChart3,
                title: "Link & Drop Analytics",
                desc: "Just paste clip URLs (TikTok, Reels, Shorts) and OpsRelic auto-fetches LIVE views, likes, and engagement metrics.",
              },
              {
                icon: RefreshCw,
                title: "CSV Mass Injection",
                desc: "Got a dump of 500 clips? Drop the CSV. We map it, sum it up, and instantly reflect performance against the campaign KPIs.",
              },
              {
                icon: Globe,
                title: "Whitelabel Client Portals",
                desc: "Stop sending PDF updates. Give your clients a live, secure `opsrelic.com/portal/[token]` link with your branding.",
              },
              {
                icon: Database,
                title: "Universal Content Database",
                desc: "Maintain complete history of every uploaded clip and tracking instance, fully searchable.",
              },
            ].map((cap, i) => (
              <motion.div
                key={i}
      ...
      <section id="features" className="section relative py-32 lg:py-48">
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="max-w-3xl mb-24">
            ...
            <h2 className="text-5xl lg:text-7xl font-bold tracking-tight mb-8 mt-4 leading-[0.9]">
              Everything in one view.
            </h2>
            <p className="text-xl text-[var(--color-text-muted)]">
              Scale your agency ops with an infrastructure that handles the
              density of real-world clipping workflows.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-6 tracking-tight">
                1. Campaign workspace, not another spreadsheet
              </h3>
              <p className="text-[var(--color-text-muted)] leading-relaxed">
                Briefs, asset uploads, status, and notes — one place per
                campaign. No more "where's that doc?" pings on Slack at 11pm.
              </p>
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-6 tracking-tight">
                2. Clip CSVs → client-ready reports in one click
              </h3>
              <p className="text-[var(--color-text-muted)] leading-relaxed">
                Drop in your CSVs from your clip pages, ad dashboards, or Whop
                campaigns. OpsRelic turns them into the KPI report you'd
                otherwise spend three hours rebuilding by hand.
              </p>
              <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-[var(--color-primary-soft)] blur-[100px] -z-0 opacity-40" />
            </motion.div>
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-6 tracking-tight">
                3. A client portal you'd actually be proud to share
              </h3>
              <p className="text-[var(--color-text-muted)] leading-relaxed">
                A clean, branded view of every campaign — live numbers,
                deliverables, next steps — so clients stop pinging you for "an
                update".
              </p>
              <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-[var(--color-primary-soft)] blur-[100px] -z-0 opacity-40" />
            </motion.div>
      ...
      <section className="py-24 lg:py-40 bg-[var(--color-surface)] border-y border-[var(--color-border)] relative overflow-hidden">
        ...
        <div className="max-w-[1180px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-24 relative z-10">
          <div>
            <span className="eyebrow text-[#00d4e8]">
              The Current State is Chaos
            </span>
            <h2 className="text-4xl lg:text-6xl font-bold tracking-tight mb-10 mt-4 leading-none">
              Exhausted by <br />
              the ops?
            </h2>
            <div className="text-[var(--color-text-muted)] space-y-6 leading-relaxed text-lg">
              <p>
                Most clipping agencies are incredible at driving virality, but
                terrible at the infrastructure.
              </p>
              <p>
                The campaign works — clippers upload, views spike.{" "}
                <strong className="text-[var(--color-text)]">
                  The nightmare is the reporting.
                </strong>
              </p>
              <p>
                Pulling numbers from five social platforms, managing
                unstructured CSV drops from clippers, stitching them into a
                Notion page, manually fixing sum totals, screen-recording a
                makeshift dashboard, and dealing with constant{" "}
                <code className="bg-[var(--color-surface-2)] px-2 py-1 rounded text-sm text-[var(--color-error)] border border-[var(--color-border)]">
                  "hey, any update on my campaign?"
                </code>{" "}
                Pings.
              </p>
            </div>
            <p className="mt-10 text-[var(--color-text-muted)] italic text-sm p-6 bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-2xl">
              If your "ops stack" is currently four Google Sheets, manual TikTok
              link scraping, and a Slack channel called #distro-urgent —{" "}
              <strong className="text-[var(--color-text)]">
                you need this.
              </strong>
            </p>
          ...
          <div className="lg:pt-0 flex flex-col justify-center">
            <span className="eyebrow text-[#00ff88]">
              The OpsRelic Solution
            </span>
            <h2 className="text-4xl font-bold tracking-tight mb-8 mt-4 leading-tight">
              We built the all in one software for clipping agency management.
            </h2>
            <div className="space-y-6 lg:space-y-8">
              {[
                {
                  t: "1-Click Metrics Collection",
                  d: "Drop clip links or CSV bundles. We scrape or parse the results natively. No more copy-pasting views.",
                  c: "#00d4e8",
                },
                {
                  t: "Agency-wide Workspaces",
                  d: "Manage your clients, client limits, billing plans, and data completely isolated in secure workspaces.",
                  c: "#00ff88",
                },
                {
                  t: "Hands-free Client Portals",
                  d: "Every campaign generates a secure portal. Clients see their live metrics on your branded page. Zero manual deck-building.",
                  c: "#a020f0",
                },
              ].map((item) => (
                <div
                  key={item.t}
                  className="p-8 rounded-[32px] bg-[var(--color-surface-2)] border border-[var(--color-border)] relative overflow-hidden group"
                >
                  <div
                    className="absolute top-0 right-0 w-32 h-32 blur-[50px] opacity-20 group-hover:opacity-40 transition-opacity"
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="p-10 lg:p-16 rounded-[48px] bg-[var(--color-primary)] text-white relative overflow-hidden">
            <div className="relative z-10 max-w-2xl">
              <span className="text-[10px] font-black uppercase tracking-[0.3em] opacity-60 mb-6 block">
                Coming in v2
              </span>
              <h2 className="text-4xl lg:text-6xl font-bold tracking-tighter mb-8 leading-none">
                The Campaign Wizard
              </h2>
              <p className="text-lg opacity-80 mb-10 leading-relaxed">
                Launch a campaign in 10 minutes, not 10 emails. Brief in, target
                KPIs in, OpsRelic spits out a structured campaign workspace with
                templates, reporting views, and "what works" insight packs.
              </p>
              <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-sm font-bold">
                <Shield className="w-4 h-4" /> Founding-tier customers get early
                access
              </div>
            </div>
      ...
      <section className="py-24 border-t border-[var(--color-border)]">
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="space-y-6">
            {[
              {
                q: "Is this another reporting dashboard?",
                a: "No. Reporting is one slice. The bigger value is the campaign workspace and the branded client portal, purpose-built for clipping and UGC agencies.",
              },
              {
                q: "Do I have to switch off my existing tools?",
                a: "No. OpsRelic sits on top. Bring your clips, bring your CSVs, bring your campaign data — OpsRelic gives them a home and a story.",
              },
              {
                q: "How is this different from generic agency tools?",
                a: "Generic tools are built for SEO or PPC. They aren't built around clipping campaigns or the high-density way creator-campaign teams report. OpsRelic is.",
              },
              {
                q: "When can I get in?",
                a: "Early access is rolling now. Drop your email in the waitlist below and we'll set you up.",
              },
            ].map((faq) => (
              <div
                key={faq.q}
                className="p-8 rounded-[32px] border border-[var(--color-border)] bg-[var(--color-surface-2)]"
              >
      ...
      <section
        id="workflow"
        className="py-32 bg-[var(--color-surface)] border-y border-[var(--color-border)]"
      >
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-lg text-[var(--color-text-muted)]">
              From client intake to performance portal in four obvious steps.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Initialize the unique operator workspace with core metadata.",
              },
              {
                step: "02",
                title: "Launch Campaign",
                desc: "Define goals, timelines, and deployment status mapping.",
              },
              {
                step: "03",
                title: "Harvest Performance",
                desc: "Upload CSV data or link performance links to campaign IDs.",
              },
              {
                step: "04",
                title: "Enable Portal",
                desc: "Publish a clean, read-only link for client-side visibility.",
              },
            ].map((s, i) => (
              <div
                key={s.title}
                className="relative group p-8 rounded-[32px] border border-[var(--color-border)] bg-[var(--color-surface-2)] hover:shadow-xl transition-all"
              >
                ...
                {i < 3 && (
                  <div className="hidden lg:block absolute top-1/2 -right-4 w-8 h-px bg-[var(--color-divider)] z-0" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 max-w-xl">
              ...
              <h2 className="text-4xl lg:text-6xl font-bold tracking-tight mb-8 mt-4">
                Precision reporting.
              </h2>
              <p className="text-xl text-[var(--color-text-muted)] mb-10">
                Stop guessing. OpsRelic gives you a microscopic view of every
                campaign with automated dashboards that move fast.
              </p>

              <div className="space-y-8">
                {[
                  {
                    t: "Live Campaign Feed",
                    d: "Every upload updates your internal dashboards and client portals instantly.",
                  },
                  {
                    t: "Operational Notes",
                    d: "Capture context on specific clips or campaign pivots within the workspace.",
                  },
                  {
                    t: "Portal Identity",
                    d: "Branded links that only show the metrics your clients care about.",
                  },
                ].map((item) => (
            ...
            <div className="flex-1 w-full grid gap-8">
              ...
              >
                <div className="flex justify-between items-center mb-10">
                  ...
                  <span className="px-3 py-1 rounded-full border border-[var(--color-border)] bg-[var(--color-surface)] text-[10px] font-bold text-[var(--color-primary)]">
                    Performance Tab
                  </span>
                </div>
                <div className="grid grid-cols-3 gap-4 mb-8">
                  {["842k Views", "28 Clips", "7.4% Eng."].map((stat) => (
                    <div
                      key={stat}
                      className="p-4 rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] text-center"
                    >
                      <div className="text-[10px] font-bold text-[var(--color-text-muted)] uppercase mb-1">
                        {stat.split(" ")[1]}
                      </div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={row.n}
                      className="px-5 py-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-between transition-all hover:bg-[var(--color-surface-offset)]"
                    >
                      <span className="font-bold text-sm tracking-tight">
                        {row.n}
                      </span>
                      <div className="flex items-center gap-4">
                        <span className="text-[10px] font-bold text-[var(--color-success)] bg-[var(--color-success)]/10 px-2.5 py-1 rounded-full border border-[var(--color-success)]/20 uppercase tracking-widest">
                          {row.s}
                        </span>
                        <span className="text-[11px] text-[var(--color-text-faint)] font-bold">
                          {row.t}
                        </span>
                      </div>
                    </div>
              ...
              >
                ...
                <div className="bg-gradient-to-b from-[var(--color-surface)] to-[var(--color-surface-offset)] border border-[var(--color-border)] rounded-2xl p-6 mb-4">
                  <div className="font-bold text-lg mb-1">
                    VoltNest — April Campaign
                  </div>
                  <div className="text-xs text-[var(--color-text-muted)]">
                    Apr 1 – Apr 30 · Updated Live
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    >
                      <div className="text-[9px] font-bold text-[var(--color-text-muted)] uppercase mb-0.5">
                        {m.split(" ")[1]}
                      </div>
                      <div className="text-lg font-black">
                        {m.split(" ")[0]}
      ...
      <section
        id="waitlist"
        className="py-40 bg-[var(--color-surface)] border-t border-[var(--color-border)]"
      >
        <div className="max-w-[1180px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-20 items-center">
            <div>
              <span className="eyebrow">Get Early Access</span>
              <h2 className="text-4xl lg:text-7xl font-bold tracking-tight mb-8 mt-4 leading-none">
                Get Early Access.
              </h2>
              <p className="text-xl text-[var(--color-text-muted)] mb-12">
                First 50 teams get founding pricing + a 1:1 setup session.
              </p>
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li
                    key={text}
                    className="flex gap-4 items-center font-bold text-[var(--color-text-muted)] group"
                  >
                ...
                {waitlistStatus === "success" ? (
                  <div className="text-center py-20 px-4">
                    ...
                    <p className="text-[var(--color-text-muted)] text-lg">
                      We've added your agency to the priority queue. Stand by
                      for verification.
                    </p>
                  </div>
                ) : (
                  <form onSubmit={handleWaitlistSubmit} className="space-y-6">
                    ...
                    {waitlistStatus === "error" && (
                      <p className="text-sm text-[var(--color-error)] font-bold text-center mt-4 uppercase tracking-widest">
          ...
          <div className="flex items-center gap-4 group">
            <div className="w-10 h-10 flex items-center justify-center transition-all group-hover:scale-110">
              <img
                src="/logo.png"
                alt="OpsRelic Logo"
                className="w-full h-full object-contain grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all"
              />
            </div>
            <div className="flex flex-col">
              <span className="font-black text-lg tracking-tighter text-[var(--color-text)]">
                OpsRelic
              </span>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-8 right-8 text-[var(--color-text-muted)] hover:text-[var(--color-text)] transition-colors"
        >
          <X className="w-8 h-8" />
        </button>
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          {mode === "signup" && (
            <div className="space-y-2">
              <label className="text-[11px] font-bold uppercase tracking-wider ml-2 text-[var(--color-text-muted)]">
                Operator Identity
              </label>
              <input
                required
                type="text"
                placeholder="Name"
                className="w-full h-12 px-6 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] placeholder:opacity-50 outline-none"
                value={name}
          ...
          <button
            disabled={loading}
            className="w-full h-14 rounded-2xl bg-[var(--color-primary)] text-[var(--color-text-inverse)] font-bold uppercase tracking-widest text-xs mt-6 hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50"
          >
            {loading
              ? "Initializing..."
              : mode === "login"
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-[9px] uppercase font-bold tracking-[0.3em] text-[var(--color-text-faint)]">
            <span className="bg-[var(--color-surface-2)] px-4">
              Secure SSO Tunnel
            </span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full h-12 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-text-muted)] font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-4 hover:bg-[var(--color-surface-offset)] transition-all"
        >
