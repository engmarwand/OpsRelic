...
export const WhopLoginButton: React.FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    <motion.button
      ...
      className={`flex items-center justify-center gap-3 bg-[#00D4FF] text-white font-bold py-3.5 px-8 rounded-2xl transition-all shadow-[0_8px_20px_rgba(0,212,255,0.25)] hover:shadow-[0_12px_30px_rgba(0,212,255,0.4)] ${className}`}
    >
