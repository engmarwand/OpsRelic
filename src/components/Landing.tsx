      ...
      >
        ...
        <div className="relative my-6">
           ...
           <div className="relative flex justify-center text-[10px]">
             <span className="bg-[#0A0A0A] px-2 text-[#555] uppercase font-bold">Or continue with</span>
           </div>
        </div>

        <div className="space-y-3">
          <WhopLoginButton className="w-full" />
          <button onClick={handleGoogleLogin} disabled={loading} className="w-full bg-white/5 border border-white/10 text-white py-3 rounded-xl hover:bg-white/10 flex items-center justify-center gap-2 text-sm">
